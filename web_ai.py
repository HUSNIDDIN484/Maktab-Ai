    ...
    st.markdown(
        ...
        .stApp {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), 
                        url("https://images.unsplash.com/photo-1523050853023-8c2d27443efb?q=80&w=2070&auto=format&fit=crop");
        ...
        .title { 
            ...
            text-shadow: 2px 2px 10px black; padding: 20px;
        }
        .user-msg { 
...
# --- TO'LIQ MAKTAB MA'LUMOTLAR BAZASI ---
def get_ai_response(prompt):
    ...
    try:
        ...
        return "Tizimda yuklama yuqori, birozdan so'ng qayta urinib ko'ring."
