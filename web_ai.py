...
st.markdown("""
    ...
    /* Xabarlar stili (Ikkala xabar ham shaffof qilingan) */
    .user-msg { 
...
# --- MAKTAB MA'LUMOTLAR BAZASI VA AI JAVOBI ---
def get_ai_response(prompt):
    ...
    # Xotirani shakllantirish (oxirgi 5 ta xabarni eslab qoladi)
...
for msg in st.session_state.messages:
    ...
    label = "Siz" if msg["role"] == "user" else "Maktab AI"
