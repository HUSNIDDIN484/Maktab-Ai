...
# Avtentifikatsiya (Rasmda ko'ringan xatolikni bartaraf etish)
auth = Authenticate(
...
if st.session_state.get("connected"):
    ...
    st.info("Savolingizni pastga yozing.")
    ...
    if prompt := st.chat_input("Nima haqida yordam bera olaman?"):
    ...
    st.title("🔑 Kirish")
    st.warning("Ilovadan foydalanish uchun Google orqali kirishingiz shart.")
    auth.login()
